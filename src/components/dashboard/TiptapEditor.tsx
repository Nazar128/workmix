...
export default function TiptapEditor({ onUpdate }: { onUpdate: (editor: any) => void }) {
  const editor = useEditor({
    ...
    editorProps: {
      attributes: {
        class: 'prose prose-sm focus:outline-none h-[160px] md:min-h-[400px] max-w-none text-gray-600',
      },
    },
    onUpdate: ({ editor }) => {
      onUpdate(editor);
