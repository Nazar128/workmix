...
export default function SideBar2() {
  ...
  return (
    <div className="h-screen w-fit bg-purple-950/20 backdrop-blur-[12px] border-l-2 border-white/10">
        ...
        >
          <div className="w-[360px] h-full flex flex-col min-w-[360px] relative p-4 overflow-hidden">
            <div className="w-full flex justify-between items-center mb-2 pb-2 border-b border-white/10">
              <span className="text-xs font-semibold uppercase tracking-wider text-purple-200">Sohbet</span>
              <button 
