  ...
  return (
    <div className="max-w-4xl  md:mx-auto p-2 text-white  min-h-screen">
      <header className="mb-4 border-b border-white/10 pb-4">
        <h1 className="text-2xl font-bold text-purple-400">Tercihler ve Hesap</h1>
        <p className="text-gray-400 text-sm mt-1">Platform deneyiminizi teknik düzeyde yapılandırın.</p>
      </header>

      <section className="mb-6 space-y-4">
        <h2 className="text-lg font-medium text-purple-400">Arayüz ve Deneyim</h2>
        <SettingItem
          label="Tema Seçimi"
      ...
      <section className="mb-4 space-y-4">
        <h2 className="text-lg font-medium text-purple-400">Hesap Durumu</h2>
      ...
      <section className="mt-12 space-y-4 border-t border-red-500/20 pt-8">
        <h2 className="text-lg font-medium text-purple-600">Oturum Ayarları</h2>
